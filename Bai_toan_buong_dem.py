...
def Count_0_125(
    ...
    # plt.show()
    if Clear_obj:
        temp_bin_img = Dilitation(temp_bin_img, 7, 1)
...
def Clear_Outside(bin_img, Big_box):
    ...
    bin_img = Dilitation(bin_img, 7, 1)
...
def Process_with_path(win_path, show_process=False):
    ...
    print(Small_boxes)
    # print("Small box origin", Small_boxes)
    # print(len(Small_boxes))
    # print(sum([len(i) for i in Small_boxes]))
